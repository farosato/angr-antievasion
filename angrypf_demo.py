...
CHECKS = [
    ...
    ('qemu_reg_key1', 0x4041fc, 0x404227),  # needs C library model
    ('qemu_reg_key2', 0x404228, 0x404253),  # needs C library model
    ('vmware_reg_key1', 0x403e93, 0x403f1e),  # needs C library model
]
